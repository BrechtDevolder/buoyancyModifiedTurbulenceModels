...
tmp<volScalarField> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::Pk
(
...
kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::epsilonByk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::kOmegaSSTBuoyancyBase
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBuoyancyBase<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
////////////////////////////////////////////////////////////////////////

    {
        ...
        (
         ...
         ==
            alpha()*rho_()*gamma*GbyNu(GbyNu0, F23(), S2())
    ...
    (
     ...
     ==
      ...
      - fvm::Sp(alpha()*rho_()*epsilonByk(F1, tgradU()), k_)
      + alpha()*rho_()*betaStar_*omegaInf_*kInf_
      + rho_*kSource()
